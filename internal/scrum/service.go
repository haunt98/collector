...
const (
	...
	message        = "message"
	collectMessage = "Update công việc tại đây nha mấy anh ơi :licklick: @haunt2"
	summaryMessage = "Em xin tổng hợp nhẹ :licklick:, copy rồi quăng qua wiki confluence nha mấy anh :licklick: @haunt2\n"
